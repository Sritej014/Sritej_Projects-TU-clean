# Hi I am Sritej Kumbar.

Thanks for dropping by as I would love to contribute to you via my passion for engineering via this GitHub.  
I am a Master's student researcher in **C++/ Simulation** in Mechanical Engineering at **TU Darmstadt**. This is Worlds **326th Ranked University** and I have worked for **SAFRAN Aerospace** which is Worlds **2nd Largest Aerospace Company**.

This is some Collection of Code/Projects where I utilised **Modern C++ for Solver Developement** & **PyTorch for Machine Learning Application in Production** at my home institute.

Please open each directories for detailed explanation.

Some codes are contributed by Users. Please honor them at their LinkedIn or Email due to their hardwork if you utilise their code.

---

## Short Brief:

### 📌 Clickable Project Index
- [1. ActiveCarSpoilerCFDSim (Colab Project India-India)](#1-activecarspoilercfdsim-colab-project-india-india)
- [2. Brusselator Solver](#2-brusselator-solver)
- [3. EmbeddedCodeLab](#3-embeddedcodelab)
- [4. HeatTransferSolver](#4-heattransfersolver)
- [5. MachineLearningDataChallenge (Colab Project India-China-German-Egpyt)](#5-machinelearningdatachallenge-colab-project-india-china-german-egpyt)
- [6. MLOpsForQualtiyDetectionWithDashboard (Colab Project India-Pakistan-German-Romania-Columbia)](#6-mlopsforqualtiydetectionwithdashboard-colab-project-india-pakistan-german-romania-columbia)
- [7. ScriptsForusefulForCFD](#7-scriptsforusefulforcfd)
...
[⬆ Back to Clickable Project Index](#-clickable-project-index)
